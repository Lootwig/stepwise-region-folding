...
internal abstract class StepFoldingLevel(private val delta: Int) : AnAction() {
  companion object {
  ...
  override fun actionPerformed(event: AnActionEvent) {
    ...
    event.apply {
      ...
      ActionUtil.performAction(levelAction, event)
    }
  }
}

internal class IncrementFoldLevel : StepFoldingLevel(1)

internal class DecreaseFoldLevel : StepFoldingLevel(-1)
